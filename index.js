...
import RedisStore from 'connect-redis'; // Import Redis store
...
const redisClient = redis.createClient({
    host: 'localhost', // Change to your Redis server host if it's not localhost
...
app.use(
    session({
        ...
        cookie: {
            ...
            httpOnly: true,           // Makes sure cookies can only be sent via HTTP(S) requests
